...
function setup(){
    ...
    block25 = new Block1(695,265,26,40);
    block26 = new Block1(708,265,26,40);
    block27 = new Block1(721,265,26,40);
    block28 = new Block1(734,265,26,40);
    block29 = new Block1(685,265,26,40);
    block30 = new Block1(669,265,26,40);

    //Blocks on top of bottom right - middle row
    block31 = new Block1(995,410,26,40);
    block32 = new Block1(1008,410,26,40);
    block33 = new Block1(982,410,26,40);
    block34 = new Block1(1021,410,26,40);
    block35 = new Block1(969,410,26,40);
    block36 = new Block1(1034,410,26,40); 

    //Blocks on top of top right - middle row
    block37 = new Block1(995,130,26,40);
    block38 = new Block1(1008,130,26,40);
    block39 = new Block1(982,130,26,40);
    block40 = new Block1(1021,130,26,40);
    block41 = new Block1(969,130,26,40);
    block42 = new Block1(1034,130,26,40); 

    //Blocks for the bottom right - top row
    block43 = new Block2(998,370,26,40);
    block44 = new Block2(1005,370,26,40);
    block45 = new Block2(989,370,26,40);
    block46 = new Block2(1013,370,26,40); 

    //Blocks for top right - top row
    block47 = new Block2(990,80,26,40);
    block48 = new Block2(1016,80,26,40);
    block49 = new Block2(964,80,26,40);
    block50 = new Block2(1042,80,26,40);

    //Blocks for center - top row
    block51 = new Block2(680.5,210,26,40);
    block52 = new Block2(706.5,210,26,40);
    block53 = new Block2(732.5,210,26,40);
